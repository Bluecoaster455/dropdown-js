...
/* harmony import */ var _DropdownJSException__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DropdownJSException */ "./src/ts/exceptions/DropdownJSException.ts");


var DropdownDoesNotExistException = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DropdownDoesNotExistException, _super);
    function DropdownDoesNotExistException(dropdownId) {
        return _super.call(this, "[DropdownJS] Dropdown Id '" + dropdownId + "' does not exist!") || this;
    }
    return DropdownDoesNotExistException;
}(_DropdownJSException__WEBPACK_IMPORTED_MODULE_1__["DropdownJSException"]));



/***/ }),

/***/ "./src/ts/exceptions/DropdownJSException.ts":
/*!**************************************************!*\
  !*** ./src/ts/exceptions/DropdownJSException.ts ***!
  \**************************************************/
/*! exports provided: DropdownJSException */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DropdownJSException", function() { return DropdownJSException; });
var DropdownJSException = /** @class */ (function () {
    function DropdownJSException(message) {
    }
    return DropdownJSException;
}());
